			...
			>
				...
				<div className='flex items-center  gap-7  -ml-[55rem]'>
					<button
						...
						onClick={openMenu}
						className={
							"w-[7rem] h-[3rem] bg-slate-400/50 rounded-lg text-white font-poppins font-medium leading-3 relative shadow xsm:text-base  shadow-slate-400 md:w-[5.5rem] md:h-[2rem]"
						}
					>
						{toggle ? "Close" : "Menu"}{" "}
						{toggle ? (
							<FaAngleUp className='absolute top-[1rem] left-[5rem] md:left-[4.2rem] md:top-2 ' />
						) : (
							<FaAngleDown className='absolute top-[1rem] left-[5rem] md:left-[4.2rem] md:top-2' />
						)}
					</button>
