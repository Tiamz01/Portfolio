						...
						<div className='grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1 items-center justify-center gap-5 px-5 rounded-xl relative '>
							{port.projects?.map((proj, i) => (
								...
								>
									...
									>
										<img
											className='w-full h-[30rem] rounded-xl object-cover bg-cover group-hover:scale-y-115'
											src={proj.img}
										...
										<div className=' absolute bottom-[0] w-full h-full  group-hover:bg-gradient-to-br from-blue-400 to-amber-200/40 rounded-lg z-20 '>
											<div className=' flex items-start flex-col gap-3 justify-center px-3 absolute top-[15rem] left-[2rem] lg:left-[0] sm:left-[4.5rem]  xsm:left-[0.5rem] opacity-0 group-hover:opacity-100 z-40 text-center '>
												<h3
